...
public class AcousticAnalyzer {
    /**
     * @param audioSamples : Complex number representing amplitude and phase in frequency
     *                     domain, where audioSamples[i][0] -> Real and
     *                     audioSamples[i][1] -> Imaginary
     * @param frameSize    : The frame size in terms of number of samples for which the
